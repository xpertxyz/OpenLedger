...
- **Filter by person** — All / Priya / Arjun pills at the top of Expense, Earn, Invest and the yearly summary, above everything they scope. Every total, bar and breakdown on the page follows the pick, and it survives month and year navigation. Only appears once a ledger is actually shared; on Earn the Add button shares that row, so a solo ledger still gets the row for the button alone.
