...
- **A target is measured against the month, not the lifetime.** The Invest bars total everything ever put in, which no monthly figure can be compared to, so a type carrying a target gets one extra grouped scan of the current month to sit against it.
