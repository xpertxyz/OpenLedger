...
- **Sub-types, one level deep** — nest "Nifty 50" and "Small cap" under "SIP". Their money rolls up into the parent's bar and counts towards the parent's target, with each child listed beneath it. Sub-types carry no target of their own.
